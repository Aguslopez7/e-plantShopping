...
function ProductList() {
    ...
    const cart = useSelector((state) => state.cart.items); // Acceder al carrito desde Redux
    ...
    return (
        <div>
            <Navbar
                ...
                handlePlantsClick={handlePlantsClick}
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1 style={{ textAlign: "center", padding: '25px', color: '#1e8449', backgroundColor: '#F9F2E7' }}>&#10045;&nbsp;{category.category}&nbsp;&#10045;</h1>
